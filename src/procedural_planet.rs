...
static THRESHOLD: [f32; 5] = [32.0, 16.0, 8.0, 4.0, 2.0];
static MAX_LOD: usize = 5;
static SUBDIVS_PER_LEVEL: usize = 64;
...
impl Planet {
    ...
    pub unsafe fn lod(&self, 
        ...
        if node.get_n_children() < 2 {
            ...
            for i in 0..6 {
                let ocean_mesh = mesh::Mesh::cs_plane(glm::vec3(1.0, 1.0, 1.0),
